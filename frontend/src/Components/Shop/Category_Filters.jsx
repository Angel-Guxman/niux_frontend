    ...
    <div className="bg-white">
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="bg-white sticky top-0 z-40 flex items-baseline justify-between border-b border-gray-200 pb-6 pt-20">
            <h1 className="text-4xl font-bold tracking-tight text-gray-600">Productos Principales</h1>
          ...
          <section aria-labelledby="products-heading" className="bg-white pb-24 pt-6">
